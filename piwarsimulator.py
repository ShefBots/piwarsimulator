...
TheWorld.append(WorldObject(object_type=ObjectType.ZONE, x=-1.25, y=0.5, radius=0.1, color='blue'))
TheWorld.append(WorldObject(object_type=ObjectType.ZONE, x=-1.25, y=-0.5, radius=0.1, color='darkgreen'))
