...
parser = argparse.ArgumentParser(description="Simulator/controller for ShefBots Mark 1b for PiWars 2024")
...
parser.add_argument("--mode", help="operation mode (default simulation)", default="simulation", choices=['simulation', 'sensor_simulation', 'control'])
